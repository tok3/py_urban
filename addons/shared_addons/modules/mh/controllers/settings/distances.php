 ...
 */
class distances extends Public_Controller
{
   protected $gridTable;
   ...
   public function __construct()
   {
	  ...
	  $this->gridTable->set_table('mh_distances');
   ...
   public function index($offset = 0)
   {
	  ...
	  $this->template
		 ->title('Entfernungsbereiche Verwalten')
		 ->set('legend','Entfernungsbereiche Verwalten')
   ...
   private function _form_fields($data = '')
   {
	  ...
	  $fields = $this->db->field_data('mh_distances');
   ...
   public function delete($_edit_id)
   {
	  ...
	  $this->db->where('distance_id',$_edit_id);
